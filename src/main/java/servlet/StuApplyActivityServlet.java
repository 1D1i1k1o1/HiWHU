...
//        String qqNum="1179641609";
        // TODO 得到报名信息数据
        Activity activity =new ActivityDaoImpl().selectActivity(activityID).get(0);
        if(DBUtill.compare(activity.getRegistrationStartTime(),time)&&DBUtill.compare(time,activity.getRegistrationEndTime())){
